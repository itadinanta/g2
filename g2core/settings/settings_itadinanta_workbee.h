/*
 * settings_itadinanta_workbee.h - test table for WorkBee custom
...
#define INIT_MESSAGE "Initializing configs to Itadinanta CNC WorkBee profile"
...
#define MOTOR_STEP_ANGLE            (360.0/200.0)
#define MOTOR_TRAVEL_PER_REV        2.0
#define MOTOR_MICROSTEPS            8

#define M1_MOTOR_MAP                AXIS_X                  // 1ma
#define M1_STEP_ANGLE               MOTOR_STEP_ANGLE        // 1sa
#define M1_TRAVEL_PER_REV           MOTOR_TRAVEL_PER_REV    // 1tr
#define M1_MICROSTEPS               MOTOR_MICROSTEPS        // 1mi  1,2,4,8,16,32
#define M1_POLARITY                 1                       // 1po  0=normal, 1=reversed
#define M1_POWER_MODE               MOTOR_POWER_MODE        // 1pm  TRUE=low power idle enabled
#define M1_POWER_LEVEL              0.500

#define M2_MOTOR_MAP                AXIS_Y
#define M2_STEP_ANGLE               MOTOR_STEP_ANGLE
#define M2_TRAVEL_PER_REV           MOTOR_TRAVEL_PER_REV
...
#define M3_STEP_ANGLE               MOTOR_STEP_ANGLE
#define M3_TRAVEL_PER_REV           MOTOR_TRAVEL_PER_REV
...
#define M4_STEP_ANGLE               MOTOR_STEP_ANGLE
#define M4_TRAVEL_PER_REV           MOTOR_TRAVEL_PER_REV
...
// Bmax/Probe
#define DI10_MODE                    IO_ACTIVE_LOW
